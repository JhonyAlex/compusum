...
CREATE UNIQUE INDEX "Cart_sessionId_status_unique_idx" ON "Cart"("sessionId", "status") WHERE "sessionId" IS NOT NULL;
...
CREATE UNIQUE INDEX "Order_sessionId_status_unique_idx" ON "Order"("sessionId", "status") WHERE "sessionId" IS NOT NULL AND "status" = 'solicitado';
CREATE UNIQUE INDEX "Order_customerId_status_unique_idx" ON "Order"("customerId", "status") WHERE "customerId" IS NOT NULL AND "status" = 'solicitado';
