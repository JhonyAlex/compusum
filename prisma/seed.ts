...
async function main() {
  ...
  const sampleProducts = [
    {
      name: "Crayones Faber-Castell x12",
      category: "Crayones y Colores",
      brand: "Faber-Castell",
      price: 8500,
      wholesale: 6500,
      minQty: 12,
    ...
    {
      name: "Lápices de Colores Kores x12",
      category: "Crayones y Colores",
      brand: "Kores",
      price: 6500,
      wholesale: 5000,
    ...
    {
      name: "Cuaderno Espiral Norma 80 Hojas",
      category: "Cuadernos y Agendas",
      brand: "Norma",
      price: 3800,
      wholesale: 2800,
    ...
    {
      name: "Plastilina Pelikan x12 Colores",
      category: "Plastilinas",
      brand: "Pelikan",
      price: 12000,
      wholesale: 9500,
      minQty: 12,
    ...
    {
      name: "Bolígrafos Bic Cristal x50",
      category: "Bolígrafos y Lápices",
      brand: "Bic",
      price: 35000,
      wholesale: 28000,
      minQty: 5,
    ...
    {
      name: "Resma Papel Oficio 500 Hojas",
      category: "Resmas y Papel",
      brand: "Legis",
      price: 22000,
      wholesale: 18000,
    ...
    {
      name: "Set Pinceles Maped x6",
      category: "Pinceles y Herramientas",
      brand: "Maped",
      price: 18500,
      wholesale: 14500,
      minQty: 6,
    ...
    {
      name: "Acrílicos Tintas y Trazos x12",
      category: "Acrílicos y Vinilos",
      brand: "Tintas y Trazos",
      price: 32000,
      wholesale: 25000,
      minQty: 6,
      sku: "TT-ACR-12",
    ...
    {
      name: "Corrector Líquido Kores x12",
      category: "Útiles Varios",
      brand: "Kores",
      price: 15000,
      wholesale: 12000,
      minQty: 12,
    ...
    {
      name: "Cinta Adhesiva Transparente x6",
      category: "Adhesivos y Cintas",
      brand: "Doricolor",
      price: 12000,
      wholesale: 9500,
      minQty: 12,
    ...
    {
      name: "Memoria USB 32GB Panasonic",
    ...
    {
      name: "Archivador de Palanca Legis",
      category: "Archivadores y Carpetas",
      brand: "Legis",
      price: 8500,
      wholesale: 6500,
      minQty: 12,
    ...
    {
      name: "Set Marcadores Lettering x8",
      category: "Marcadores Lettering",
      brand: "Faber-Castell",
      price: 25000,
      wholesale: 19500,
      minQty: 6,
    ...
    {
      name: "Organizador de Escritorio 4 Gavetas",
    ...
    {
      name: "Mouse Inalámbrico Panasonic",
    ...
    {
      name: "Lápiz Mecánico Pilot 0.5mm",
      category: "Bolígrafos y Lápices",
      brand: "Pilot",
      price: 8500,
      wholesale: 6500,
    ...
    {
      name: "Cuaderno Profesional Familia 200 Hojas",
      category: "Cuadernos y Agendas",
      brand: "Familia",
      price: 15000,
      wholesale: 12000,
